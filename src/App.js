...
class App extends Component {
  ...
  refreshHits = (query = '', page = 0) => {
    fetch(
      `https://hn.algolia.com/api/v1/search_by_date?tags=story&query=${query}&page=${page}`
    )
      ...
      <React.Fragment>
        <div id="cover" className="container-fluid">
          <div className="container">
            ...
            <p>
              News & articles for information security professionals.
              <br />A project by Zack Webster.
            </p>
